					...
					<div className="glass-panel p-4 md:p-6 rounded-2xl">
						<div className="flex items-center gap-3 mb-4">
							...
							<div className="flex-1">
								<h2 className="font-headline-md text-headline-md text-on-surface dark:text-zinc-100">Activity Log</h2>
								{statusLines.length > 0 && (
									<p className="text-[12px] text-on-surface-variant/60 dark:text-zinc-400">{statusLines.length} entr{statusLines.length === 1 ? 'y' : 'ies'}</p>
								)}
							</div>
							{statusLines.length > 0 && (
								<button
