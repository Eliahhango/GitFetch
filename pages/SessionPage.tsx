			...
			<main className="flex-grow pt-24 md:pt-28 pb-32 md:pb-20 px-4 md:px-8 max-w-container-max mx-auto w-full relative">
				...
				<div className="max-w-4xl mx-auto">
					<section className="space-y-2 md:space-y-3 mb-8">
						<h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface">Session</h2>
					...
					<div className="glass-panel p-4 md:p-6 rounded-2xl">
						<div className="flex items-center gap-3 mb-6">
							...
							<h2 className="font-headline-md text-headline-md text-on-surface">Session Stats</h2>
						</div>
								...
								{totalFiles > 0 && downloadedFiles > 0 && (
									<div className="mt-6">
										<div className="flex justify-between items-center mb-2">
											...
											<span className="text-[12px] text-on-surface-variant/60">{Math.round((downloadedFiles / totalFiles) * 100)}%</span>
										</div>
